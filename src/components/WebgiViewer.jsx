...
const WebgiViewer=forwardRef((props,ref)=>{
  ...
  const memoizedScrollAnimation=useCallback((position,target,isMobile,onUpadate)=>{
    if(position && target && onUpadate){
      scrollAnimation(position,target,isMobile,onUpadate);
    }
  },[])
